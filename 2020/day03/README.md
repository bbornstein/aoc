...
**`O`** where there was an open square and **`X`** where there was a
tree:
...
To run:
    ...
    $ ./aoc-2020-d03.py
    Part 1: Trees encountered: 220.
    Part 2: Product of trees encountered: 2138320800.

Any fans of *[The West Wing](https://en.wikipedia.org/wiki/The_West_Wing)* (or [Aaron Sorkin](https://en.wikipedia.org/wiki/Aaron_Sorkin), in
general)?  Did you notice the use of the phrase "sudden arboreal stop"
above?

I can't find a clip, but here's an excerpt from [IMDb Leo McGarry
quotes](https://www.imdb.com/title/tt0745667/characters/nm0817983):

  * **C.J. Cregg**: Is there anything I can say other than the President
  ...
  * **Leo McGarry**: He rode his bicycle into a tree, C.J., what do you
    want me - the President, while riding his bicycle on his vacation
    in Jackson Hole, came to a *sudden arboreal stop*.
